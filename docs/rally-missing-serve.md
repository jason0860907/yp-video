...
判定：rally span `[start, end]` 內最前的動作事件不是 `serve`。共 86 筆。
...
| 0601小窩季打 2 | 1 | 0:04 | 0:58 | receive | receive → set → spike → receive → set → spike |
| 0601小窩季打 2 | 14 | 4:40 | 4:54 | receive | receive → set → spike → receive → set → spike |
| 0601小窩季打 2 | 22 | 6:50 | 7:01 | receive | receive → set → spike → receive → set → spike |
| 10⧸4 2 | 12 | 5:12 | 5:20 | receive | receive → set → spike → block → score |
| 10⧸4 3 | 14 | 3:52 | 4:00 | receive | receive |
| 2025-10-11_G8_臺中連莊_vs_桃園雲豹飛將_set1 | 1 | 0:05 | 0:07 | set | set → spike → score |
| 2025-10-11_G8_臺中連莊_vs_桃園雲豹飛將_set1 | 26 | 15:26 | 15:32 | set | set → score |
| 2025-11-08_G19_臺北伊斯特_vs_臺中連莊_set1 | 43 | 25:57 | 26:02 | receive | receive → set → spike → score |
| 20250424 排島惡館-7 | 9 | 4:38 | 4:47 | set | set → spike → receive → set → spike → score |
| 20250504 大統OB-成功大學vs台北大學B-第二局 | 1 | 0:18 | 0:36 | receive | receive → set → spike → block → receive → set |
| 20250504 大統OB-成功大學vs台北大學B-第二局 | 20 | 9:00 | 9:06 | receive | receive → set → spike → score |
| 20251109-排島本館-03 | 5 | 2:14 | 2:21 | receive | receive → receive → set → receive → spike → score |
| 20251109-排島本館-03 | 11 | 4:38 | 4:50 | spike | spike → receive → set → spike → receive → set |
| 20251109-排島本館-03 | 47 | 16:24 | 16:39 | set | set → receive → set → spike → receive → set |
| 20260403-霖度C-01_set1 | 22 | 8:46 | 9:00 | receive | receive → set → receive → receive → set → spike |
...
## 附錄 A：span 內有 2 個以上 `serve` — 126 筆

間隔不到 0.5 秒的，是同一個 `serve` 被標了兩次，不是兩個。

| 影片 | Rally | 起 | 訖 | serve 數 | 最小間隔 |
|---|---:|---:|---:|---:|---:|
| 03⧸14(六) 14_00｜例行賽G103 #雲林美津濃 vs. #桃園臺灣產險｜企業21年甲級男女排球聯賽_set3 | 18 | 12:45 | 12:51 | 5 | 0.00s |
...
| 03⧸15(日) 13_00｜例行賽G106 #屏東台電 vs. #雲林美津濃｜企業21年甲級男女排球聯賽_set1 | 41 | 24:13 | 24:20 | 5 | 0.00s |
| 03⧸15(日) 13_00｜例行賽G106 #屏東台電 vs. #雲林美津濃｜企業21年甲級男女排球聯賽_set2 | 13 | 5:36 | 5:43 | 5 | 0.00s |
| 03⧸15(日) 13_00｜例行賽G106 #屏東台電 vs. #雲林美津濃｜企業21年甲級男女排球聯賽_set2 | 28 | 24:29 | 24:36 | 2 | 1.05s |
...
| 03⧸22(日) 17_00｜男子組冠軍賽 G117 #屏東台電 vs. #雲林美津濃｜企業21年甲級男女排球聯賽_set1 | 26 | 14:38 | 14:44 | 2 | 0.22s |

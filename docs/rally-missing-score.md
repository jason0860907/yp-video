...
判定：rally span `[start, end]` 內沒有 `score` 動作事件。共 249 筆。

分類：`結尾切太早` = span 外 3 秒內就有 score，標註在、是邊界停早了；`疑似漏標` = 前後都找不到鄰近的 score。

## 疑似漏標 — 208 筆

| 影片 | Rally | 起 | 訖 | 末個動作 | 動作序列（後 6） |
|---|---:|---:|---:|---|---|
...
| 影片 | Rally | 起 | 訖 | 末個動作 | score 距結尾 | 動作序列（後 6） |
|---|---:|---:|---:|---|---:|---|
...
## 附錄 A：score 之後還有動作 — 107 筆

span 內有 score，但它不是最後一個事件 —— 與「serve 不在最前」對稱。

| 影片 | Rally | 起 | 訖 | score 距結尾 | score 後動作數 | 動作序列（後 6） |
|---|---:|---:|---:|---:|---:|---|
| 0104排島臨打 3 | 34 | 12:52 | 13:06 | 4.1s | 3 | receive → set → score → spike → receive → set |
| 0323小窩臨打 3 | 19 | 6:27 | 6:38 | 1.8s | 1 | spike → receive → set → spike → score → set |
| 03⧸14(六) 16_00｜例行賽G104 #獅子王 vs. #屏東台電｜企業21年甲級男女排球聯賽_set1 | 15 | 6:18 | 6:27 | 2.4s | 1 | receive → set → spike → block → score → set |
| 03⧸14(六) 18_00｜例行賽G105 #高雄台電 vs. #新北中纖｜企業21年甲級男女排球聯賽_set1 | 11 | 4:46 | 4:53 | 1.2s | 1 | receive → set → spike → block → score → receive |
| 03⧸21(六) 18_00｜男子組冠軍賽G114 #雲林美津濃 vs. #屏東台電｜企業21年甲級男女排球聯賽_set1 | 11 | 6:03 | 6:12 | 3.6s | 2 | receive → set → spike → score → receive → set |
| 03⧸21(六) 18_00｜男子組冠軍賽G114 #雲林美津濃 vs. #屏東台電｜企業21年甲級男女排球聯賽_set1 | 34 | 19:35 | 19:42 | 2.5s | 2 | serve → receive → score → spike → receive |
| 03⧸21(六) 18_00｜男子組冠軍賽G114 #雲林美津濃 vs. #屏東台電｜企業21年甲級男女排球聯賽_set1 | 39 | 22:18 | 22:26 | 0.8s | 1 | set → spike → block → receive → score → receive |
| 03⧸21(六) 18_00｜男子組冠軍賽G114 #雲林美津濃 vs. #屏東台電｜企業21年甲級男女排球聯賽_set1 | 40 | 22:50 | 23:01 | 1.9s | 1 | spike → receive → set → spike → score → receive |
| 03⧸22(日) 17_00｜男子組冠軍賽 G117 #屏東台電 vs. #雲林美津濃｜企業21年甲級男女排球聯賽_set1 | 2 | 0:22 | 0:36 | 3.6s | 2 | block → receive → set → score → spike → block |
| 03⧸22(日) 17_00｜男子組冠軍賽 G117 #屏東台電 vs. #雲林美津濃｜企業21年甲級男女排球聯賽_set2 | 30 | 19:22 | 19:28 | 1.7s | 3 | receive → set → score → spike → block → receive |
| 03⧸22(日) 17_00｜男子組冠軍賽 G117 #屏東台電 vs. #雲林美津濃｜企業21年甲級男女排球聯賽_set3 | 4 | 1:19 | 1:35 | 2.2s | 1 | receive → set → spike → block → score → receive |
| 0419小窩臨打 2 | 37 | 14:08 | 14:28 | 2.4s | 1 | set → spike → receive → set → score → spike |
| 0420小窩季打 2 | 11 | 3:38 | 3:58 | 3.1s | 2 | spike → receive → set → score → spike → receive |
| 0420小窩季打 3 | 15 | 4:12 | 4:20 | 2.8s | 1 | serve → receive → set → score → spike |
| 0727小窩季打 2 | 13 | 4:50 | 5:14 | 0.0s | 1 | spike → receive → set → receive → score → receive |
| 2025-10-05_G5_臺北伊斯特_vs_桃園雲豹飛將_set1 | 6 | 2:31 | 2:37 | 1.0s | 1 | serve → receive → set → spike → score → block |
| 2025-10-05_G5_臺北伊斯特_vs_桃園雲豹飛將_set1 | 35 | 24:48 | 24:56 | 2.7s | 1 | serve → receive → set → spike → score → receive |
| 2025-10-12_G9_臺中連莊_vs_台鋼天鷹_set1 | 47 | 28:58 | 29:12 | 2.0s | 1 | receive → receive → set → spike → score → receive |
| 2025-10-25_G11_臺北伊斯特_vs_桃園雲豹飛將_set1 | 26 | 14:08 | 14:16 | 1.5s | 2 | receive → set → spike → score → block → receive |
| 2025-11-01_G15_臺中連莊_vs_臺北伊斯特_set1 | 32 | 18:36 | 18:43 | 0.9s | 1 | serve → receive → set → spike → score → receive |
| 2025-11-01_G15_臺中連莊_vs_臺北伊斯特_set1 | 36 | 20:28 | 20:38 | 0.8s | 1 | set → spike → receive → set → score → spike |
| 2025-11-08_G19_臺北伊斯特_vs_臺中連莊_set1 | 47 | 29:31 | 29:37 | 3.2s | 1 | serve → score → receive |
| Bulgaria 🇧🇬 vs. Canada 🇨🇦 ｜ VNL 2025 - Full Match ｜ Week 1_set1 | 46 | 27:32 | 27:38 | 1.2s | 1 | serve → receive → set → spike → score → receive |
| Bulgaria 🇧🇬 vs. Japan 🇯🇵 ｜ VNL 2025 - Full Match ｜ Week 1_set1 | 14 | 6:04 | 6:12 | 2.1s | 1 | receive → set → spike → receive → score → receive |
| Bulgaria 🇧🇬 vs. Japan 🇯🇵 ｜ VNL 2025 - Full Match ｜ Week 1_set1 | 37 | 18:52 | 18:58 | 3.4s | 2 | serve → score → receive → set |
| Canada 🇨🇦 vs Japan 🇯🇵 ｜ VNL 2025 - Full Match ｜ Week 1_set1 | 4 | 1:31 | 1:38 | 1.2s | 1 | serve → receive → set → spike → score → receive |
| Canada 🇨🇦 vs Japan 🇯🇵 ｜ VNL 2025 - Full Match ｜ Week 1_set1 | 10 | 4:03 | 4:08 | 2.4s | 1 | serve → score → receive |
| Canada 🇨🇦 vs Japan 🇯🇵 ｜ VNL 2025 - Full Match ｜ Week 1_set1 | 31 | 15:37 | 15:54 | 2.0s | 1 | set → spike → block → receive → score → set |
| Canada 🇨🇦 vs Japan 🇯🇵 ｜ VNL 2025 - Full Match ｜ Week 1_set1 | 50 | 34:58 | 35:02 | 1.5s | 1 | serve → score → receive |
| China vs. Argentina - Classification 13-16 ｜ Boys' U19 World Champs 2025 - Full Match_set1 | 2 | 0:33 | 0:43 | 2.5s | 1 | receive → set → spike → receive → score → set |
| China vs. Brazil - Ranking 13-14 ｜ Boys' U19 World Champs 2025 - Full Match_set1 | 6 | 2:36 | 2:45 | 2.7s | 2 | set → spike → block → score → receive → receive |
| China vs. Brazil - Ranking 13-14 ｜ Boys' U19 World Champs 2025 - Full Match_set1 | 19 | 7:53 | 8:04 | 2.6s | 1 | receive → set → spike → block → score → receive |
| China 🇨🇳 vs. Japan 🇯🇵 ｜ VNL 2025 - Full Match ｜ Week 1_set1 | 3 | 1:56 | 2:06 | 2.7s | 1 | serve → receive → receive → spike → score → receive |
| Cuba vs. Puerto Rico - Ranking 17-18 ｜ Boys' U19 World Champs 2025 - Full Match_set1 | 22 | 10:15 | 10:31 | 2.9s | 2 | receive → receive → spike → score → receive → receive |
| France 🇫🇷 vs. Japan 🇯🇵 ｜ VNL 2025 - Full Match ｜ Week 2_set1 | 19 | 9:53 | 10:01 | 2.4s | 1 | receive → set → spike → block → score → receive |
| France 🇫🇷 vs. Japan 🇯🇵 ｜ VNL 2025 - Full Match ｜ Week 2_set1 | 41 | 21:11 | 21:24 | 3.4s | 2 | receive → set → score → spike → receive → receive |
| Full Match ｜ Bulgaria vs Luxembourg ｜ CEV U22 Volleyball European Championship 2026 Women ｜ Pool E_set1 | 31 | 14:42 | 14:58 | 2.7s | 2 | receive → set → spike → score → receive → receive |
| Full Match ｜ Croatia vs. Bulgaria ｜ CEV U22 Volleyball European Championship 2026 Women ｜ Pool E_set1 | 24 | 10:02 | 10:14 | 3.3s | 1 | set → spike → receive → set → score → spike |
| Full Match ｜ Croatia vs. Serbia ｜ CEV U22 Volleyball European Championship 2026 Women ｜ Pool E_set1 | 21 | 8:55 | 9:16 | 4.2s | 2 | set → spike → block → score → receive → receive |
| Full Match ｜ Denmark vs. England ｜ CEV U22 Volleyball European Championship 2026 Men ｜ Pool A_set1 | 11 | 7:16 | 7:26 | 2.3s | 1 | serve → receive → set → spike → score → receive |
| Full Match ｜ Denmark vs. England ｜ CEV U22 Volleyball European Championship 2026 Men ｜ Pool A_set1 | 18 | 10:30 | 10:40 | 4.0s | 2 | receive → set → spike → score → receive → receive |
| Full Match ｜ Ireland vs. Spain ｜ CEV U22 Volleyball European Championship 2026 Women ｜ Pool D_set1 | 9 | 3:21 | 3:34 | 1.8s | 1 | spike → receive → set → spike → score → receive |
| Full Match ｜ Ireland vs. Spain ｜ CEV U22 Volleyball European Championship 2026 Women ｜ Pool D_set1 | 11 | 5:06 | 5:16 | 4.3s | 2 | set → spike → block → score → receive → set |
| Full Match ｜ Ireland vs. Türkiye ｜ CEV U22 Volleyball European Championship 2026 Women ｜ Pool D_set1 | 13 | 5:29 | 5:46 | 1.7s | 1 | spike → receive → set → spike → score → receive |
| Full Match ｜ Ireland vs. Türkiye ｜ CEV U22 Volleyball European Championship 2026 Women ｜ Pool D_set1 | 14 | 6:58 | 7:05 | 1.6s | 1 | serve → receive → set → score → receive |
| Full Match ｜ Ireland vs. Türkiye ｜ CEV U22 Volleyball European Championship 2026 Women ｜ Pool D_set1 | 19 | 8:48 | 9:02 | 3.1s | 1 | block → receive → set → spike → score → set |
| Full Match ｜ Italy vs. England ｜ CEV U22 Volleyball European Championship 2026 Men ｜ Pool A_set1 | 30 | 16:41 | 16:52 | 0.7s | 1 | receive → set → spike → block → score → receive |
| Full Match ｜ Luxembourg vs. Croatia - CEV U22 Volleyball European Championship 2026 ｜ Women ｜ Pool E_set1 | 1 | 0:05 | 0:14 | 1.9s | 1 | set → spike → receive → receive → score → receive |
| Full Match ｜ Norway vs. Bulgaria ｜ CEV U22 Volleyball European Championship 2026 Men ｜ Pool C_set1 | 21 | 9:14 | 9:23 | 2.6s | 2 | receive → set → spike → score → receive → receive |
| Full Match ｜ Norway vs. Ireland ｜ CEV U22 Volleyball European Championship 2026 Women ｜ Pool D_set1 | 37 | 19:05 | 19:38 | 4.0s | 0 | receive → set → spike → receive → score → set |
| Full Match ｜ Poland vs. England ｜ CEV U22 Volleyball European Championship 2026 Women ｜ Pool C_set1 | 4 | 1:24 | 1:32 | 2.1s | 1 | serve → receive → set → spike → score → receive |
| Full Match ｜ Poland vs. Slovakia ｜ CEV U22 Volleyball European Championship 2026 Women ｜ Pool C_set1 | 26 | 11:57 | 12:06 | 4.0s | 1 | serve → receive → score → receive |
| Full Match ｜ Serbia vs. Bulgaria ｜ CEV U22 Volleyball European Championship 2026 Women ｜ Pool E_set1 | 20 | 8:10 | 8:20 | 1.6s | 1 | receive → set → spike → receive → score → receive |
| Full Match ｜ Serbia vs. Luxembourg ｜ CEV U22 Volleyball European Championship 2026 Women ｜ Pool E_set1 | 34 | 17:25 | 17:34 | 1.6s | 1 | receive → set → receive → receive → score → receive |
| Full Match ｜ Türkiye vs. Spain ｜ CEV U22 Volleyball European Championship 2026 Women ｜ Pool D_set1 | 40 | 21:22 | 21:38 | 4.6s | 3 | set → spike → score → set → spike → receive |
| Japan vs. USA - Ranking 15-16 ｜ Boys' U19 World Champs 2025 - Full Match_set1 | 26 | 10:14 | 10:21 | 3.0s | 1 | serve → receive → score → receive |
| Japan vs. USA - Ranking 15-16 ｜ Boys' U19 World Champs 2025 - Full Match_set1 | 31 | 13:23 | 13:31 | 2.2s | 1 | serve → receive → set → spike → score → receive |
| Japan 🇯🇵 vs. Czechia 🇨🇿 ｜ VNL 2025 - Full Match ｜ Week 2_set1 | 22 | 9:50 | 9:56 | 2.2s | 1 | receive → set → spike → receive → score → receive |
| Japan 🇯🇵 vs. Dominican Republic 🇩🇴 ｜ VNL 2025 - Full Match ｜ Week 1_set1 | 24 | 11:02 | 11:15 | 3.6s | 2 | receive → set → spike → score → receive → set |
| Japan 🇯🇵 vs. Dominican Republic 🇩🇴 ｜ VNL 2025 - Full Match ｜ Week 1_set1 | 25 | 11:32 | 11:42 | 2.7s | 1 | spike → receive → receive → receive → score → receive |
| Japan 🇯🇵 vs. Dominican Republic 🇩🇴 ｜ VNL 2025 - Full Match ｜ Week 1_set1 | 29 | 13:26 | 13:34 | 2.6s | 1 | serve → receive → set → spike → score → receive |
| Japan 🇯🇵 vs. France 🇫🇷 ｜ VNL 2025 - Full Match ｜ Week 3_set1 | 36 | 17:57 | 18:28 | 19.9s | 15 | receive → receive → receive → set → spike → block |
| Japan 🇯🇵 vs. Netherlands 🇳🇱 ｜ VNL 2025 - Full Match ｜ Week 1_set1 | 2 | 0:25 | 0:35 | 3.9s | 3 | spike → receive → score → receive → spike → receive |
| Japan 🇯🇵 vs. Netherlands 🇳🇱 ｜ VNL 2025 - Full Match ｜ Week 1_set1 | 23 | 10:53 | 11:10 | 3.2s | 2 | set → spike → block → score → receive → receive |
| Japan 🇯🇵 vs. Netherlands 🇳🇱 ｜ VNL 2025 - Full Match ｜ Week 1_set1 | 31 | 15:06 | 15:14 | 2.7s | 2 | receive → set → spike → score → receive → set |
| Japan 🇯🇵 vs. Netherlands 🇳🇱 ｜ VNL 2025 - Full Match ｜ Week 1_set1 | 43 | 21:20 | 21:32 | 5.2s | 2 | receive → set → spike → score → receive → receive |
| Japan 🇯🇵 vs. Serbia 🇷🇸 ｜ VNL 2025 - Full Match ｜ Week 1_set1 | 38 | 16:51 | 16:59 | 1.4s | 1 | receive → set → spike → receive → score → spike |
| Jtekt Stings 🇯🇵 - Suntory Sunbirds Osaka 🇯🇵 ｜ SV League 2026 ｜ Full Match - Volleyball_set1 | 31 | 17:17 | 17:30 | 1.4s | 1 | receive → set → spike → block → score → receive |
| Korea vs. Finland - Ranking 11-12 ｜ Boys' U19 World Champs 2025 - Full Match_set1 | 21 | 7:25 | 7:32 | 1.5s | 0 | serve → receive → set → score → spike |
| Korea vs. Finland - Ranking 11-12 ｜ Boys' U19 World Champs 2025 - Full Match_set1 | 44 | 19:50 | 19:58 | 3.1s | 1 | serve → receive → set → spike → score → receive |
| Osaka Bluteon 🇯🇵 vs. JTEKT Stings 🇯🇵 ｜ SV League 2026 ｜ Full Match - Volleyball_set1 | 23 | 11:23 | 11:31 | 2.5s | 2 | set → spike → block → score → receive → set |
| Osaka Bluteon 🇯🇵 vs. JTEKT Stings 🇯🇵 ｜ SV League 2026 ｜ Full Match - Volleyball_set1 | 42 | 22:28 | 22:36 | 1.9s | 1 | serve → receive → set → spike → score → receive |
| Pakistan vs. USA - Classification 13-16 ｜ Boys' U19 World Champs 2025 - Full Match_set1 | 1 | 0:07 | 0:14 | 2.4s | 2 | serve → receive → set → score → spike → receive |
| Pakistan vs. USA - Classification 13-16 ｜ Boys' U19 World Champs 2025 - Full Match_set1 | 6 | 2:26 | 2:34 | 2.1s | 1 | serve → receive → set → spike → score → receive |
| Pakistan vs. USA - Classification 13-16 ｜ Boys' U19 World Champs 2025 - Full Match_set1 | 16 | 7:38 | 7:55 | 2.1s | 1 | set → spike → block → receive → score → receive |
| Poland vs. Spain - Semi Final 1 ｜ Boys' U19 World Champs 2025 - Full Match_set1 | 35 | 19:57 | 20:06 | 1.8s | 1 | serve → receive → set → spike → score → receive |
| Semi Final 1 - Osaka Bluteon vs. Stings Aichi ｜ SV League - Full Match ｜ Volleyball_set1 | 8 | 3:45 | 3:52 | 1.6s | 1 | receive → set → spike → block → score → receive |
| Semi Final 1 - Osaka Bluteon vs. Stings Aichi ｜ SV League - Full Match ｜ Volleyball_set1 | 18 | 8:57 | 9:04 | 1.6s | 1 | serve → receive → set → spike → score → block |
| Semi Final 1 - Osaka Bluteon vs. Stings Aichi ｜ SV League - Full Match ｜ Volleyball_set1 | 42 | 25:36 | 25:56 | 3.2s | 1 | receive → set → spike → block → score → receive |
| Semi Final 2 - Osaka Bluteon vs. Stings Aichi ｜ SV League - Full Match ｜ Volleyball_set1 | 30 | 16:30 | 16:36 | 3.7s | 2 | serve → score → set → spike |
| Semi Final 2 - Osaka Bluteon vs. Stings Aichi ｜ SV League - Full Match ｜ Volleyball_set1 | 39 | 23:08 | 23:16 | 2.8s | 1 | serve → receive → block → score → receive |
| Spain vs. Iran - Ranking 3-4 ｜ Boys' U19 World Champs 2025 - Full Match_set1 | 14 | 10:01 | 10:10 | 3.2s | 1 | serve → receive → receive → receive → score → receive |
| Spain vs. Iran - Ranking 3-4 ｜ Boys' U19 World Champs 2025 - Full Match_set1 | 16 | 11:03 | 11:16 | 2.8s | 1 | receive → block → receive → score → set → spike |
| Suntory Sunbirds vs. Osaka Bluteon ｜ SV.LEAGUE 2025⧸26 ｜ Full Match - Volleyball_set1 | 23 | 10:53 | 11:00 | 2.0s | 1 | serve → receive → set → spike → score → receive |
| Suntory Sunbirds 🇯🇵 vs. Stings AICHI 🇯🇵 ｜ SV League 2026 ｜ Full Match - Japan Volleyball_set1 | 6 | 3:19 | 3:27 | 2.4s | 1 | receive → set → spike → block → score → receive |
| Suntory Sunbirds 🇯🇵 vs. Stings AICHI 🇯🇵 ｜ SV League 2026 ｜ Full Match - Japan Volleyball_set1 | 30 | 14:25 | 14:37 | 3.1s | 1 | receive → set → spike → block → score → receive |
| Taipei vs. Argentina - Playoffs ｜ Girls' U19 World Champs 2025 - Full Match_set1 | 7 | 3:28 | 3:47 | 1.9s | 1 | receive → set → spike → receive → score → set |
| Taipei vs. Argentina - Playoffs ｜ Girls' U19 World Champs 2025 - Full Match_set1 | 12 | 6:19 | 6:36 | 3.0s | 1 | receive → set → spike → receive → score → receive |
| Taipei vs. Argentina - Playoffs ｜ Girls' U19 World Champs 2025 - Full Match_set1 | 22 | 12:57 | 13:06 | 2.8s | 2 | receive → set → spike → score → receive → set |
| Türkiye vs. Colombia - Classification 13-16 ｜ Boys' U19 World Champs 2025 - Full Match_set1 | 9 | 5:33 | 5:41 | 2.1s | 1 | set → spike → block → receive → score → receive |
| Türkiye vs. Colombia - Classification 13-16 ｜ Boys' U19 World Champs 2025 - Full Match_set1 | 27 | 12:41 | 12:50 | 2.5s | 2 | set → spike → block → score → receive → receive |
| Türkiye vs. Colombia - Classification 13-16 ｜ Boys' U19 World Champs 2025 - Full Match_set1 | 29 | 13:32 | 13:40 | 2.7s | 1 | serve → receive → spike → block → score → set |
| Türkiye vs. Colombia - Classification 13-16 ｜ Boys' U19 World Champs 2025 - Full Match_set1 | 31 | 15:39 | 15:51 | 4.4s | 3 | block → receive → score → receive → receive → set |
| Uzbekistan vs. Pakistan - Ranking 5-6 ｜ Boys' U19 World Champs 2025 - Full Match_set1 | 15 | 6:09 | 6:17 | 2.6s | 1 | receive → set → spike → block → score → receive |
| ᴴᴰ114UVL預賽：：中原大學vs陽明交大：：男一級 大專排球聯賽 AI網路直播_set1 | 17 | 8:10 | 8:19 | 2.8s | 1 | serve → receive → set → spike → score → receive |
| ᴴᴰ114UVL預賽：：中原大學vs陽明交大：：男一級 大專排球聯賽 AI網路直播_set1 | 23 | 11:37 | 11:45 | 4.0s | 1 | serve → receive → score → receive |
| ᴴᴰ114UVL預賽：：中原大學vs陽明交大：：男一級 大專排球聯賽 AI網路直播_set1 | 24 | 11:55 | 12:04 | 2.0s | 1 | serve → receive → set → spike → score → receive |
| ᴴᴰ114UVL預賽：：中原大學vs陽明交大：：男一級 大專排球聯賽 AI網路直播_set1 | 38 | 18:28 | 18:38 | 2.5s | 1 | set → spike → block → receive → score → receive |
| ᴴᴰ114UVL預賽：：中原大學vs陽明交大：：男一級 大專排球聯賽 AI網路直播_set1 | 39 | 18:55 | 19:03 | 2.8s | 2 | receive → set → spike → score → receive → set |
| ᴴᴰ114UVL預賽：：國北教大vs嘉義大學：：男一級 大專排球聯賽 AI網路直播_set1 | 1 | 0:32 | 0:40 | 1.9s | 1 | serve → receive → set → spike → score → set |
| ᴴᴰ114UVL預賽：：臺灣師大vs中山大學：：男一級 大專排球聯賽 AI網路直播_set1 | 23 | 9:13 | 9:24 | 0.4s | 1 | receive → set → spike → receive → score → spike |
| 【LIVE】𝗙𝗨𝗟𝗟 𝗠𝗔𝗧𝗖𝗛｜TPVL  2025-26 例行賽 G21 11⧸9 15_00 桃園雲豹飛將 vs 臺中連莊_set1 | 39 | 19:25 | 20:03 | 2.6s | 1 | receive → receive → set → spike → score → receive |
| 【LIVE】𝗙𝗨𝗟𝗟 𝗠𝗔𝗧𝗖𝗛｜TPVL  2025-26 例行賽 G23 11⧸15 15_00 臺中連莊 vs 台鋼天鷹_set1 | 24 | 11:12 | 11:29 | 2.6s | 1 | receive → set → spike → receive → score → receive |
| 【LIVE】𝗙𝗨𝗟𝗟 𝗠𝗔𝗧𝗖𝗛｜TPVL  2025-26 例行賽 G24 11⧸15 18_30 桃園雲豹飛將 vs 臺北伊斯特_set1 | 9 | 4:19 | 4:26 | 0.9s | 1 | serve → receive → set → spike → score → receive |
| 【LIVE】𝗙𝗨𝗟𝗟 𝗠𝗔𝗧𝗖𝗛｜TPVL  2025-26 例行賽 G24 11⧸15 18_30 桃園雲豹飛將 vs 臺北伊斯特_set1 | 25 | 11:40 | 11:50 | 1.3s | 2 | block → receive → score → set → spike → block |
| 【LIVE】𝗙𝗨𝗟𝗟 𝗠𝗔𝗧𝗖𝗛｜TPVL  2025-26 例行賽 G24 11⧸15 18_30 桃園雲豹飛將 vs 臺北伊斯特_set1 | 45 | 24:13 | 24:31 | 2.0s | 1 | block → receive → set → spike → score → receive |
| 【LIVE】𝗙𝗨𝗟𝗟 𝗠𝗔𝗧𝗖𝗛｜TPVL  2025-26 例行賽 G26 11⧸16 18_30 臺中連莊 vs 臺北伊斯特_set1 | 17 | 9:20 | 9:29 | 2.7s | 2 | set → spike → block → score → receive → receive |

## 附錄 B：span 內有 2 個以上 score — 21 筆

| 影片 | Rally | 起 | 訖 | score 數 |
|---|---:|---:|---:|---:|
| 0323小窩臨打 3 | 37 | 11:47 | 11:58 | 2 |
| 03⧸15(日) 17_00｜例行賽G108 #新北中纖 vs. #高雄台電｜企業21年甲級男女排球聯賽_set3 | 21 | 12:23 | 12:30 | 2 |
| 0427小窩季打 11 | 34 | 13:38 | 13:46 | 2 |
| 0427小窩季打 11 | 43 | 16:52 | 17:12 | 2 |
| 0601小窩季打 2 | 10 | 3:34 | 3:39 | 2 |
| 0803小窩季打 1 | 15 | 5:12 | 5:38 | 2 |
| 1005小窩臨打 1 | 4 | 3:53 | 4:02 | 2 |
| 1005小窩臨打 1 | 33 | 13:07 | 13:16 | 2 |
| 2025-09-28_G2_臺北伊斯特_vs_桃園雲豹飛將_set2 | 33 | 19:16 | 19:22 | 2 |
| 20250424 排島惡館-7 | 7 | 3:43 | 4:06 | 2 |
| Bulgaria vs. Italy - Ranking 7-8 ｜ Boys' U19 World Champs 2025 - Full Match_set1 | 12 | 5:48 | 5:56 | 2 |
| Bulgaria 🇧🇬 vs. Canada 🇨🇦 ｜ VNL 2025 - Full Match ｜ Week 1_set1 | 17 | 10:30 | 10:34 | 2 |
| Canada 🇨🇦 vs Japan 🇯🇵 ｜ VNL 2025 - Full Match ｜ Week 1_set1 | 39 | 21:15 | 21:22 | 2 |
| Canada 🇨🇦 vs Japan 🇯🇵 ｜ VNL 2025 - Full Match ｜ Week 1_set1 | 49 | 34:38 | 34:42 | 2 |
| France 🇫🇷 vs. Japan 🇯🇵 ｜ VNL 2025 - Full Match ｜ Week 2_set1 | 33 | 15:50 | 15:56 | 3 |
| Full Match ｜ Bulgaria vs Luxembourg ｜ CEV U22 Volleyball European Championship 2026 Women ｜ Pool E_set3 | 37 | 18:34 | 18:42 | 2 |
| Full Match ｜ Serbia vs. Bulgaria ｜ CEV U22 Volleyball European Championship 2026 Women ｜ Pool E_set1 | 6 | 2:27 | 2:30 | 2 |
| Japan vs. USA - Ranking 15-16 ｜ Boys' U19 World Champs 2025 - Full Match_set1 | 45 | 21:39 | 21:48 | 2 |
| Japan 🇯🇵 vs. Czechia 🇨🇿 ｜ VNL 2025 - Full Match ｜ Week 2_set1 | 7 | 2:35 | 2:46 | 2 |
| Japan 🇯🇵 vs. Czechia 🇨🇿 ｜ VNL 2025 - Full Match ｜ Week 2_set1 | 25 | 10:52 | 11:05 | 2 |
| ᴴᴰ114UVL預賽：：中山大學vs國北教大：：男一級 大專排球聯賽 AI網路直播_set1 | 35 | 15:42 | 15:58 | 2 |

## 附錄 C：span 內完全沒有動作 — 3 筆
...
| 2025-09-27_G1_臺北伊斯特_vs_臺中連莊_set1 | 42 | 28:35 | 28:39 |

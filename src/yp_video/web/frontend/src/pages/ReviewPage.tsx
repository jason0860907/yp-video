...
function scorePill(a: EditorAnnotation) {
  ...
  const cls = a.score > 0.7 ? 'text-emerald-400 bg-emerald-500/10 ring-emerald-500/20' : a.score > 0.4 ? 'text-amber-400 bg-amber-500/10 ring-amber-500/20' : 'text-text-muted bg-white/5 ring-white/10';

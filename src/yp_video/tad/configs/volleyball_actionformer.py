...
annotation_path = "src/yp_video/tad/data/annotations/volleyball_anno.json"
class_map = "src/yp_video/tad/data/annotations/category_idx.txt"
data_path = "src/yp_video/tad/data/features/"
...
work_dir = "src/yp_video/tad/checkpoints/actionformer"
